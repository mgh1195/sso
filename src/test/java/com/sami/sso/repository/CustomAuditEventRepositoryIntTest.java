package com.sami.sso.repository;

import com.sami.sso.SsoApp;
import com.sami.sso.config.Constants;
import com.sami.sso.config.audit.AuditEventConverter;
import com.sami.sso.domain.PersistentAuditEvent;
...
import static com.sami.sso.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
